...
We also now support **native async context** for the _Vue composition API_ ([#23526](https://github.com/nuxt/nuxt/pull/23526)). In case you're unaware, we support native async context on Node and Bun, enabled with `experimental.asyncContext`.
...
Today, you can cutomize the options for the built-in `<NuxtLink>`, directly in your `nuxt.config` file ([#23724](https://github.com/nuxt/nuxt/pull/23724)).
